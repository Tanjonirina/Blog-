...
@section('css')
<link rel="stylesheet" href="{{asset('Asset/css/custome/login.css')}}">
@endsection('css')
          ...
          <div class="col-md-6">
              <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <form action="{{route('submite.login')}}" class=" px-mb-5 px-3" method="POST">
                        @csrf
                          <div class="mb-3 mt-3">
                            <label for="email" class="form-label text"><i class=" fa fa-envelope"></i> Email:
                              {{-- message --}}
                                    @error('email')
                    ...
                    @enderror
                          ...
                          <div class="mb-3">
                            <label for="pwd" class="form-label text"><i class="fa fa-lock"></i> Password:
                            {{-- message --}}
                            @error('password')
                            <div class="alert mb-4 r">
                            <div class="text-danger" style="text-align: center;">{{$message}}</div>
